...
export class JobServicePartialPermissionStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    jobsTable.grantReadData(apiHandler);
    jobsTable.grantReadData(workerHandler);

    rawBucket.grantRead(apiHandler);
